...
async def write_report(
    research_id: str, custom_prompt: Optional[str] = None
) -> Dict[str, Any]:
    """
...
def run_server():
    ...
    try:
        if transport == "stdio":
            ...
            # Use FastMCP's run method - it uses default endpoint
            mcp.run(
        ...
        # Note: If we reach here, the server has stopped (for stdio/sse transports)
